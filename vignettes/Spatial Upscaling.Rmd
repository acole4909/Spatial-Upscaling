...
The random cross-validation had a lower RMSE than the spatial cross-validation and a higher RSQ.
...
The spatial cross-validation had higher RMSE than the environmental cross-validation. The environmental cross-validation has a higher RSQ than the spatial cross-validation.
